...
begin
    ...
    hazard_det: process (rs1_address_id_i, rs2_address_id_i, rd_address_ex_i, 
                         mem_to_reg_ex_i, rs1_in_use_i, rs2_in_use_i, stall_i--, scalar_load_req_i, scalar_store_req_i,
                        -- all_v_loads_executed_i, all_v_stores_executed_i, vector_stall_i, vector_instr_i
                        ) is
    begin
        -- Load in ex.st. 
